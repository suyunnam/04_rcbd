...
# If there is quite low P value (here it's 0.09) of rep, there must be potential heterogeneous conditions among blocks. So RCBD was a good choice over CRD
```
...
# ":" Check only the interaction effect. No main effect
...
- make the stat result as a dataframe
- trim the letter
- add trt name column
